...
-- İsimleri "Visuals" olarak standartlaştırdım (Daha temiz çalışır)
local Pages = {["COMBAT ⚔️"] = Instance.new("Frame", Main), ["Visuals"] = Instance.new("Frame", Main), ["Settings"] = Instance.new("Frame", Main)}
...
-- [Visuals]
local btnE = Instance.new("TextButton", Pages["Visuals"]); btnE.Size = UDim2.new(0.8, 0, 0, 40); btnE.Position = UDim2.new(0.1, 0, 0.05, 0); btnE.Text = "ESP: OFF"
btnE.MouseButton1Click:Connect(function() ESPEnabled = not ESPEnabled; btnE.Text = "ESP: "..(ESPEnabled and "ON" or "OFF") end)
local btnF = Instance.new("TextButton", Pages["Visuals"]); btnF.Size = UDim2.new(0.8, 0, 0, 40); btnF.Position = UDim2.new(0.1, 0, 0.2, 0); btnF.Text = "Circle: OFF"
...
local sF = Instance.new("TextButton", Pages["Visuals"]); sF.Size = UDim2.new(0.8, 0, 0, 40); sF.Position = UDim2.new(0.1, 0, 0.35, 0); sF.Text = "Circle Boyut (Kaydır)"
...
local tabNames = {"COMBAT ⚔️", "Visuals", "Settings"}
for i, name in pairs(tabNames) do 
    local b = Instance.new("TextButton", Sid); b.Size = UDim2.new(1,0,0,50); b.Text = name; b.BackgroundColor3 = Color3.fromRGB(40,40,40); b.TextColor3 = Color3.new(1,1,1); b.Position = UDim2.new(0,0,0,(i-1)*50); 
